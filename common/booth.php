                                            ...
                                            <div class="container" id="DynamicBoothsContainerParent" style="height:438px;;">
                                                <div id="mTS_1" class="mTSWrapper mTS_horizontal" style="overflow: inherit;">
                                                    <ul id="mTS_1_container" class="mTSContainer" style="position: relative; top: 0px; left: 0px; width: 4861px; overflow: inherit;"> 
                                                        <?php
                                                            $data = file_get_contents('http://www.jobmindz.com/api/BigJobDay/company-name?CompanyName=');
                                                            $data = json_decode($data,true); $count = 0; $count_j=1; 
                                                            //print_r($data["all_Company"]);
                                                            ...
                                                            <?php } ?>                        
                                                                                    <td align="center" class="leicester-booth" id="SmallBooth-TD-3718">
                                                                                        <div><h4 onClick="view('<?php echo $base.'job-fair/sbooth/'.$funObj->en_de('en',$value['recruiter_id']); ?>/')" style="cursor:pointer;width:200px;padding:10px;background:#323232;color:#fff;margin:5px"><?php echo ucwords(strtolower($value['compName'])); ?></h4></div>
                                                                                        <div id="Small-Booth-Main-Div-Area-LargeViewWrapper-3718" class="SmallBoothContainer booth-sm-even">
                                                                                            ...
                                                                                            <a onClick="view('<?php echo $base.'job-fair/sbooth/'.$funObj->en_de('en',$value['recruiter_id']); ?>/')"  id="Small-Booth-Image-LargeViewWrapper-3718" class="demo-tip-darkgray" title="<?php echo $value['compName']; ?>" >
                                                                                                <img id="SmallBooth-LargeViewWrapper-3718" src="<?php echo $booth; ?>" alt="<?php echo $value['compName']; ?>" style="width: 230px; height: 113px;">
                                                                                            </a>
                                                                                        </div>
                                                                                        <div class="thumbs">
                                                                                            <div class="logo-container">
                                                                                                <a onClick="view('<?php echo $base.'job-fair/sbooth/'.$funObj->en_de('en',$value['recruiter_id']); ?>/')"  class="demo-tip-darkgray" title="Bristol-Myers Squibb" onclick="showBooth('LargeViewWrapper-4503')" href="javascript:;">
                                                                                                    <img class="Railing-Banners-Ashfaq" data="ashfaq" src="<?php echo $value['company_img']; ?>" alt="Logo">
                                                                                                </a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </td>
